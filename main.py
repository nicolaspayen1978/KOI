...
ClimateTech_GRID = ['AGX', 'PWR', 'HUNGF', 'AGR', 'POWERGRID.NS', 'NGG', '600517.SS', 'AEP', 'XEL', 'PRY.MI', 'TOSYY', 'PLPC', 'POWL', '298040.KS', 'POWERINDIA.NS', 'ABBNY', 'KEC.NS', 'JYOTISTRUC.NS', 'LT.NS', 'NKT.CO', 'SMNEY', 'GE', 'SU.PA', 'GEV']
